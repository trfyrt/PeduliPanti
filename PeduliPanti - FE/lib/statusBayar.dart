...
class StatusBayar extends StatefulWidget {
  const StatusBayar({super.key});

  @override
  State<StatusBayar> createState() => _StatusBayarAppState();
}

class _StatusBayarAppState extends State<StatusBayar> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StatusBayarPage(title: 'Peduli Panti'),
      debugShowCheckedModeBanner: false,
    );
  }
}

class StatusBayarPage extends StatefulWidget {
  const StatusBayarPage({super.key, required this.title});

  final String title;

  @override
  State<StatusBayarPage> createState() => _StatusBayarPageState();
}

class _StatusBayarPageState extends State<StatusBayarPage> {
  @override
