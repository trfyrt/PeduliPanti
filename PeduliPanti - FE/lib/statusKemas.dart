...
class StatusKemas extends StatefulWidget {
  const StatusKemas({super.key});

  @override
  State<StatusKemas> createState() => _StatusKemasAppState();
}

class _StatusKemasAppState extends State<StatusKemas> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StatusKemasPage(title: 'Peduli Panti'),
      debugShowCheckedModeBanner: false,
    );
  }
}

class StatusKemasPage extends StatefulWidget {
  const StatusKemasPage({super.key, required this.title});

  final String title;

  @override
  State<StatusKemasPage> createState() => _StatusKemasPageState();
}

class _StatusKemasPageState extends State<StatusKemasPage> {
  @override
                                  ...
                                  child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                      ...
                                      shape: RoundedRectangleBorder(
                                        ...
                                        side: BorderSide(
                                          color: Color.fromARGB(255, 147, 181,
                                              255), // Warna border
