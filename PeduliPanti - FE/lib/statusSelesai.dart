...
class StatusSelesai extends StatefulWidget {
  const StatusSelesai({super.key});

  @override
  State<StatusSelesai> createState() => _StatusSelesaiAppState();
}

class _StatusSelesaiAppState extends State<StatusSelesai> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StatusSelesaiPage(title: 'Peduli Panti'),
      debugShowCheckedModeBanner: false,
    );
  }
}

class StatusSelesaiPage extends StatefulWidget {
  const StatusSelesaiPage({super.key, required this.title});

  final String title;

  @override
  State<StatusSelesaiPage> createState() => _StatusSelesaiPageState();
}

class _StatusSelesaiPageState extends State<StatusSelesaiPage> {
  @override
